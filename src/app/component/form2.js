    ...
    <>
      <div className="mt-10 bg-white">
        <form action="" className="border border-dotted p-6">
            ...
            <span className='global_font'>Sed tortor, sed velit ridiculus ipsum pharetra lacus odio gravida augue enim.</span>
            <div className="flex mt-2">
                <button className="p-1 border bg-orange-200 border-gray-300 rounded-md mr-2 hover:bg-gray-900 hover:text-white" >English</button>
                <button  className="p-1 border border-gray-300 rounded-md mr-2 hover:bg-gray-900 hover:text-white">Turkish</button>
            </div>
